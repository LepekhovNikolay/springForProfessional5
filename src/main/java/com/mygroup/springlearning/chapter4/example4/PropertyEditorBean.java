package com.mygroup.springlearning.chapter4.example4;
...
public class PropertyEditorBean {
    ...
    public void setStringList(List<String> stringList) {
        ...
        for (String string : stringList) {
            System.out.println("String rnernЬer: " + string);
        }
    }
    ...
    public static class CustomPropertyEditorRegistrar
        ...
        public void registerCustomEditors
            ...
            SimpleDateFormat dateFormatter =
                    new SimpleDateFormat("ММ/dd/yyyy");
        ...
        public static void main(String... args) throws Exception {
            ...
            ctx.load("classpath:spring/chapter4/ch4ex4-app-context.xml");
            ctx.refresh();
